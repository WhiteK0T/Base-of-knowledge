...
> Расшифровка колонки флагов пиров — [Флаги пиров qBittorrent](Torrent%20Flags.md). Автообновление раздач через этот же WebUI — [emonoda](emonoda%20%E2%80%94%20автообновление%20торрентов%20%28qBittorrent%29.md).
...
> *Настройки → Веб-интерфейс → «Обходить аутентификацию для клиентов на localhost»* — удобно, когда к WebUI ходят только локальные инструменты (например [emonoda](emonoda%20%E2%80%94%20автообновление%20торрентов%20%28qBittorrent%29.md)); тогда логин/пароль им не нужны.
...
> [emonoda](emonoda%20%E2%80%94%20автообновление%20торрентов%20%28qBittorrent%29.md) при обновлении торрента **не переносит категорию/метку** на новую версию (плагин qB не поддерживает «кастомы») — после апдейта категорию может понадобиться вернуть вручную.
