...
![Netfilter components](Netfilter-components.svg)
...
![Схема прохождения пакетов](iptables-chain.jpg)

### Схема цепочек 
![Схема цепочек](iptables-chain1.png)
