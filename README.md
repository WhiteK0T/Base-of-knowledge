...
![Заметок](https://img.shields.io/badge/Заметок-144-success)
...
- **OSINT / разведка:** [Web Check — OSINT-досье на сайт (DNS/SSL/заголовки/стек/порты)](Security/OSINT/Web%20Check%20%E2%80%94%20OSINT-досье%20на%20сайт%20%28DNS-SSL-заголовки-стек-порты%29.md)
