...
Личная база знаний — «второй мозг» в виде заметок [Obsidian](https://obsidian.md/). Это не программный проект: здесь нет сборки, тестов и зависимостей, только Markdown-файлы (преимущественно на русском). Obsidian читает каталог напрямую, а на GitHub репозиторий служит каталогом-витриной.
