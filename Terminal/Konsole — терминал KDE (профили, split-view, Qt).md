...
## ⚖️ Konsole vs GPU-терминалы

| | Konsole | [kitty](kitty%20%E2%80%94%20GPU-терминал%20с%20kittens%20и%20графикой%20%28OpenGL%29.md) | [Rio](Rio%20%E2%80%94%20быстрый%20терминал%20на%20WebGPU%20%28Rust%29.md) | [Alacritty](Alacritty%20%E2%80%94%20GPU-терминал%20на%20OpenGL%20%28минимализм%29.md) |
| :--- | :--- | :--- | :--- | :--- |
| Рендер | Qt (CPU) | OpenGL | WebGPU | OpenGL |
| Настройка | **GUI/профили** | конфиг | конфиг | конфиг |
| Вкладки/сплиты | да | да | да | нет |
| Интеграция | **глубоко в KDE** | — | — | — |
| Скриптинг | D-Bus / KPart | remote control | — | — |
| Вес | тяжелее (KDE/Qt) | средний | средний | **лёгкий** |
